...
describe SubscribeController do
  ...
  it "should successfully call on_next method on details and set the user session - valid user new user, non-trial subscription" do
    user = Factory(:user)
  ...
  it "should successfully call on_next method on details and set the user session - nil user, non-trial subscription" do
  ...
  it "should successfully call on_next method on details and set the user session - valid user new user, trial subscription" do
  ...
  #   # User.delete_all # just in case
  #   offer = Factory(:offer)
  #   offer_term = Factory(:offer_term, :months => '3')
  #   publication = Factory(:publication)
  #   subscription = Subscription.new()
  #   subscription.offer = offer
  #   subscription.price = "15"
  #   subscription.expires_at = Date.strptime("2010-10-31", '%Y-%m-%d')
  #   new_expires_at = Date.strptime("2010-1-31", '%Y-%m-%d') # old expires_at plus 3 months
  #   
  ...
  #   assigns[:subscription].expires_at.should     == new_expires_at
  ...
  # end
  # 
  # it "should successfully skip the payment and end the wizard if the offer is a trial-existing user" do
  #   user = Factory(:user) # create and save the user
  #   User.all.size.should == 1
  #   
  #   # # on_get(:details)
  ...
  # 
  #   # to on_next(:details)
  #   post :details, {:commit => 'Next', :new_or_existing => 'existing'}, {}, :subscription => { :user_attributes => {:login => user.login, :password => user.password}}
  # 
  #   assigns[:new_or_existing].should            == 'existing'
  #   session[:user_dat].should be_nil
  #   User.first.login.should == 'login'
  # 
  #   assigns[:subscription].should_not             be_new_record # subscription wizard active record should be saved(with trial)
  #   assigns[:subscription].state.should           == 'trial'    # because it was a trial offer
  #   assigns[:subscription].price.should           == subscription.price
  #   assigns[:subscription].offer.id.should        == subscription.offer.id
  #   assigns[:subscription].publication.should_not be_nil
  #   assigns[:subscription].user.should_not        be_nil
  #   assigns[:subscription].user.id.should         == user.id
  #   assigns[:subscription].user.recurrent_id.should be_nil
  # 
  #   flash[:notice].should   == "Congratulations! Your subscribtion was successful."
  #   flash[:error].should     be_nil
  #   response.should redirect_to(:action => :offer)
  # end
  # 
  # it "should successfully skip the payment and end the wizard if the offer is a trial-new user" do
  # end
end
