ActionController::Routing::Routes.draw do |map|
  ...
  map.namespace :admin do |admin|
    ...
    admin.namespace :reports do |reports|
      ...
      reports.resources :free_trials
      reports.resources :free_trials_overview, :collection => {:set_daterange => [:get, :post]}
  ...
  map.with_options  :controller => 'subscribe' do |s|
    ...
    s.paypal_express '/subscribe/paypal', :action => "paypal_express", :conditions => { :method => :post }
    s.paypal_express_return '/subscribe/paypal_return', :action => "paypal_express_return", :conditions => { :method => :get }
  ...
  map.namespace :webhooks do |webhooks|
    webhooks.unbounce "unbounce", :action => "create", :controller => "unbounces"
  end
